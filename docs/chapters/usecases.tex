...
Nella figura seguente, la gerarchia tra gli attori è stata posta sulla sinistra col fine di semplificare graficamente le associazioni con i casi d'uso: gli attori, dunque, non sono duplicati.
\begin{table}[!ht]
	\centering
...
\begin{itemize}
	\item \Req{rf}{01}, \Req{rf}{06} Modellati nello UCD da VisualizzaCatalogo con l'attore UtenteRegistrato
	\item \Req{rf}{02} Modellato nello UCD da AggiungiFarmaco con l'attore primario Farmacista
	\item \Req{rf}{03} Modellato nello UCD da ModificaFarmaco con l'attore primario Farmacista
	\item \Req{rf}{04} Modellato nello UCD da EliminaFarmaco con l'attore primario Farmacista
	\item \Req{rf}{05} Modellato nello UCD da RegistraCliente con l'attore primario Cliente non Registrato
	\item \Req{rf}{07}, \Req{rf}{08}, \Req{rf}{09}, \Req{rf}{10}, \Req{rf}{17} Modellati nello UCD da CreaOrdine con l'attore primario Cliente
	\item \Req{rf}{11} Modellato nello UCD da VisualizzaOrdiniAcquisto con l'attore primario Farmacista
	\item \Req{rf}{12} Modellato nello UCD da RegistraConsegnaOrdineAcquisto con l'attore primario Farmacista
	\item \Req{rf}{13} Modellato nello UCD da GeneraReport con l'attore primario Direttore
	\item \Req{rf}{14} Modellato nello UCD da VisualizzaOrdiniFarmacia con l'attore primario Farmacista
	\item \Req{rf}{15} Modellato nello UCD da RitiraOrdine con l'attore primario Cliente e attore secondario Farmacista
	\item \Req{rf}{16} Modellato nello UCD da VisualizzaStoricoOrdini con l'attore primario Cliente
	\item \Req{rf}{18} Modellato nello UCD da CercaFarmaco con l'attore primario UtenteRegistrato
	\item \Req{rf}{19} Modellato nello UCD da GeneraOrdineAcquistoFarmacista con l'attore primario Farmacista
