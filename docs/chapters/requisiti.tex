...
\begin{tblr}{
	...
	ID & Requisito & Origine \\
	\Req{rd}{01} & {I farmaci sono caratterizzati da nome, codice identificativo, \\ prezzo e tipologia di farmaco} & 1 \\
	\Req{rd}{02} & Un farmaco può essere da banco o da prescrizione & 2 \\
	\Req{rd}{03} & {Di ogni cliente si vogliono memorizzare le informazioni personali e \\ lo storico dei farmaci acquistati} & 8 \\
	\Req{rd}{04} & {Il report fornisce informazioni sul numero totale di farmaci venduti, \\ sulla loro categoria di vendita e sull'incasso totale in un dato periodo} & 17 \\
\end{tblr}
